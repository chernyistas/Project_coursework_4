...
class MailingAdmin(admin.ModelAdmin):
    list_display = ("id", "start_time", "end_time", "created_at", "status", "short_message", "clients_count")
    ...
    def short_message(self, obj):
        ...
        return f"{obj.message.subject[:30]}..." if len(obj.message.subject) > 30 else obj.message.subject
